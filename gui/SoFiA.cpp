...
void SoFiA::createWhatsThis()
{
	...
	tabInputFieldFlagCube->setWhatsThis(tr("<h3>flag.file</h3><p>Full path and file name of an optional file containing the flags of pixels in the input cube. The flags will be applied before running the source finder. The pixels that are flagged will be set to NaN in the data cube. The default is to not apply flags.</p>"));
	...
	tabInputGroupBox3->setWhatsThis(tr("<h3>steps.doFlag</h3><p>Flag pixel and channel ranges before proceeding. Details are specified with the <b>flag.regions</b> and the <b>flag.file</b> option.</p>"));
