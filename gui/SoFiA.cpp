...
void SoFiA::createWhatsThis()
{
    ...
    tabOutputButtonOverwrite->setWhatsThis(tr("<h3>writeCat.overwrite</h3><p>If <b>true</b>, overwrite any existing output files without warning. If <b>false</b>, terminate the pipeline whenever an existing output file is encountered.</p>"));
